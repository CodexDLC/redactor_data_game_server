# File: core/node_editor/node_editor_service.py (version 0.5)
...
class NodeEditorService:
    def __init__(self, view: INodeEditorView, nodes_panel: INodesPanelView, repository: INodeRepository):
        self.view = view
    ...
    def _load_initial_data(self):
        # Этот метод больше не вызывается из __init__, но остается здесь
